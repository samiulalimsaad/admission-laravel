        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full">
            ...
            <div class="my-8">
                ...
                <div class="bg-info text-info-content p-4 text-center">
                    <p class="my-4">
                        আপনি রাজশাহী বিশ্ববিদ্যালয়ে নিচের ইউনিট গুলিতে ভ্তির প্রাথমিক আবেদন করতে পারবেন।
                    </p>
                    <div class="divider"></div>
                    ...
                    <dialog id="number_verification" class="modal">
                        <div class="modal-box">
                            ...
                            <div class="text-left space-y-4">
                                ...
                                <ul class="space-y-4">
                                    <li>
                                        * মোবাহল নম্বরাট অবশ্যহ প্রাথার]নভডেোর অথবা অভিভাবকের হতে হবে ।

                                    </li>
                                    <li>
                                        * একই মোব স্বর এবাাধব: প্রার্থীর জন্য ব্যবহার করা যাবে না।
                                ...
                                <div class="alert my-4">
                                    ...
                                    করুন। মোবাইল নম্বর নিশ্চিত করার জন্য আপনার ।
